...
public class WaterIntakeService {
    ...
    public WaterIntakeDTO getWaterIntakeDTO(Login user, LocalDate date) {
        // Fetch the WaterIntake record for the user and date, sorted by date in descending order, and limit the result to one row.
        ...
        if (intake != null) {
            ...
            // If no record is found, return a DTO with default values
