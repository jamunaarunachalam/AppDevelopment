...
export default function Newregister() {
  ...
  return (
    ...
    <div className='pic'><img src="https://domf5oio6qrcr.cloudfront.net/medialibrary/12598/86c68bee-e424-4c98-a593-9b0d5a770913.jpg" height="600px" width="600px"/>
   ...
   <Link to="/"> <button type="submit" className='button1' onClick={authenticate}>Login</button></Link>
    </form></div>
